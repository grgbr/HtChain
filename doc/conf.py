...
latex_documents = [
    (master_doc, 'htchain.tex', u'HtChain Documentation',
...
man_pages = [
    (master_doc, 'htchain', u'HtChain Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HtChain', u'HtChain Documentation',
     author, 'HtChain', 'One line description of project.',
     'Miscellaneous'),
]
